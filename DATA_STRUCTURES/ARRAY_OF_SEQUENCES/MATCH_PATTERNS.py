...
class ColombianLot:
    ...
    def __destructures_names_in_tuples(self, interested_party_names_tuple: tuple):
        match interested_party_names_tuple:
            ## For a corrient name
            case (str(type_id), names, (first_lastname, second_lastname)) if type_id:
                self.interested_parties.append(InterestedParty(type, names, (first_lastname, second_lastname)))
            ## For a ancient name of a woman
            case (str(type_id), names, (first_lastname, middle_lastname, second_lastname)) if type_id and middle_lastname.lower() == "de":
                self.interested_parties.append(InterestedParty(type, names, (first_lastname, second_lastname)))
